...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    let stuONe=Student(firstName: "xixi", lastName: "li", age: 20, gender: .female, stuNo: "0001")
    let stuTwo=Student(firstName: "wawa", lastName: "ji", age: 20, gender: .female, stuNo: "0002")
    let stuThree=Student(firstName: "shiqi", lastName: "ha", age: 20, gender: .female, stuNo: "0003")
    let stuFour=Student(firstName: "ji", lastName: "ke", age: 20, gender: .female, stuNo: "0004")
    let teacOne=Teacher(firstName: "guyan", lastName: "li", age: 40, gender: .male, title: "教授")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if identifier=="teacher"
        {
           ...
           teacherCell.teacherFirstNmae.text = tec.lastName+tec.firstName
            ...
            teacherCell.teacherImage.image=UIImage(named: images[indexPath.row%3])
    teacherCell.teacherImage.layer.cornerRadius=teacherCell.teacherImage.frame.size.width/2
        ...
        else
        {
           ...
           studentCell.studentImge.image=UIImage(named: images[3-indexPath.row%3])
